...
public class faqInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//initializing the parameters used for the insert function
		...
		//initializing a variable for the result of the insert function
		boolean isTrue;
		
		//calling the insert function from the DBUtil 
		isTrue = faqDBUtil.insertFaq( userType, name, email, phone, question);
